...
// Provider Icons - Used in Sidebar and Settings
export const ProviderIcons: Record<string, (props: React.SVGProps<SVGSVGElement> & { color?: string }) => React.ReactElement> = {
  chatgpt: ({ color, ...props }) => (
  ...
  ollama: ({ color, ...props }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" {...props}>
