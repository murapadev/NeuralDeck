/**
 * Shared Icons for NeuralDeck
 * Centralized SVG icons for providers and UI elements
 */

import React from 'react'

// Provider Icons - Used in Sidebar and Settings
export const ProviderIcons: Record<string, (color: string) => React.ReactElement> = {
  chatgpt: (color) => (
...
// UI Icons - Used across multiple components
...
// Helper to get provider icon by ID or icon name
export function getProviderIcon(iconName: string, color: string): React.ReactElement {
  const IconComponent = ProviderIcons[iconName] || ProviderIcons.custom
